...
function square(arr) {
    let squared = arr.map(arr => arr * arr);
    return squared;
}
// -------------------------------------------------------------------------------------------------------
...
function fullName(arr) {
    let fName = arr.map(arr => `${arr.firstName} ${arr.lastName}`);
    return fName;
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
    let result = []; 
    arr.map(element => { 
    let obj = { firstName: element.firstName, lastName: element.lastName, gradsList: element.gradsList, avg: findAvg(element.gradsList) }; 
    result.push(obj); }); 
    function findAvg(arrAvg) { 
    let sum = 0; for (let i = 0; i < arrAvg.length; i++) { 
    sum += arrAvg[i]; 
    } 
    let finalAvg; 
    finalAvg = sum / arrAvg.length; 
    return finalAvg; } 
    return result;
}
// -------------------------------------------------------------------------------------------------------
