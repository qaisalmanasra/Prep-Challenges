...
const objLat = (obj) => {
     ...
     let fNameCap = fName.charAt(0).toUpperCase() + fName.slice(1);
     let lName = obj.lastName;
     let lNameCap = lName.charAt(0).toUpperCase() + lName.slice(1);
     let x = `my name is ${fNameCap} ${lNameCap} I am ${obj.age} YO, and I love ${obj.hobby}.`;
...
const cvFormatter = (arr) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        const arr2 = arr[i];
        if (arr2.lastName === null && arr2.yearsOfExperience > 1) {
            x.push({ fullName: `${arr2.firstName}`, tech: `${arr2.tech}` });

        } else if (arr2.yearsOfExperience > 1) {
            x.push({ fullName: `${arr2.firstName} ${arr2.lastName}`, tech: `${arr2.tech}` });
        } else continue;
    } return x;
};
// -------------------------------------------------------------------------------------------------------
